...
<template>
  <MainLayout :pageTitle="pageTitle">
    <section>
<body class="bg-amber-700 text-gray-100 px-8 py-12">
      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <div class="text-gray-700 mt-8">
              Want some questions? Send me an <span class="underline">email</span> instead.
            </div>
          </div>
        ...
        <div class="">
          <div>
            <span class="uppercase text-sm text-blue-600 font-bold">Full Name</span>
            <input class="w-full bg-blue-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text" placeholder="">
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-blue-600 font-bold">Email</span>
            <input class="w-full bg-blue-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              type="text">
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-blue-600 font-bold">Message</span>
            <textarea
              class="w-full h-32 bg-blue-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
          </div>
          <div class="mt-8">
            <button
              class="uppercase text-sm font-bold tracking-wide bg-blue-500 text-blue-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
