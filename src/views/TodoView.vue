...
<template>
   ...
   <MainLayout :pageTitle="pageTitle">
    ...
    <div class="main">
        ...
        <div class="card">
            <div class="title">
            <h1 class="text-purple-700 text-5xl mb-14">Todo App</h1>
            </div>
            <div class="mb-14">
            ...
            <form @submit.prevent="addTask" class="flex items-center">
                ...
                <button class="bg-purple-500 text-white" type="submit">Add</button>
            </form>
            </div>
            <div class="tasks">
...
<style scoped>
  ...
  .card {
    border: 1px solid #3490dc; /* Change border color */
    border-radius: 8px;
    padding: 20px;
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
    max-width: 400px;
    background-color: #eb8613; /* Change background color */
  }
