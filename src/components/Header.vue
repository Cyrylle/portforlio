        ...
        <nav class="mx-auto max-w-screen-xl px-12 py-4">
            <div class="flex flex-row items-center justify-between">
                <router-link to="/" class="flex flex-col">
                    <h1 class="font-bold text-xl text-blue-700">Cyrylle Nate Sanchez</h1>
                    <p class="font-light text-lg text-blue-800">BSIT 4B</p>
                </router-link>
                ...
                <div class="hidden lg:block">
                    <ul class="flex flex-row gap-8">
                        <li
                            :class="$route.name === 'home' ? 'text-blue-700 font-medium text-lg' : 'text-blue-700 hover:text-gray-700 font-normal text-lg'">
                            <router-link to="/">Home</router-link>
                        </li>
                        <li
                            :class="$route.name === 'about' ? 'text-blue-700 font-medium text-lg' : 'text-blue-700 hover:text-gray-700 font-normal text-lg'">
                            <router-link to="/about">About</router-link>
                        </li>
                        <li
                            :class="$route.name === 'projects' ? 'text-blue-700 font-medium text-lg' : 'text-blue-700 hover:text-gray-700 font-normal text-lg'">
                            <router-link to="/projects">Projects</router-link>
                        </li>
                        <li
                            :class="$route.name === 'contact' ? 'text-blue-700 font-medium text-lg' : 'text-blue-700 hover:text-gray-700 font-normal text-lg'">
